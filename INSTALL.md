...
**Запросы роли** лежат в массиве `role_requests` продуктового описания или предметной
модели — у каждого есть идентификатор `RR-…`, текст, что блокируется до ответа и что
произойдёт при отрицательном ответе.
